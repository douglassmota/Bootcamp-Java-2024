...
<p align="center">
<img src="https://github.com/cami-la/collections-java-api-2023/blob/master/assets/image/collection-framework.png"><br>
...
<p align="center">
<img src="https://github.com/cami-la/collections-java-api-2023/blob/master/assets/image/collection-framework-methods.png" alt="List interface hierarchy Java"><br>
...
3. Execute o seguinte comando para mudar a URL remota para SSH:
   ...
   ```shell
   git remote set-url origin git@github.com:douglassmota/collections-java-api-2024
